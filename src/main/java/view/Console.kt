...
object Console {
    fun print(character: Character) {
        ...
        println("On the knees: ${character.onTheKnees}")
        println("Attack style: ${character.attackStyle}")
        println("Defense style: ${character.defenseStyle}")
        println()
        ...
        println()
        println("Attack action left: ${character.attackAction}")
        println("Defense action left: ${character.defenseAction}")
